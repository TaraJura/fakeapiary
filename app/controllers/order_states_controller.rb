class OrderStatesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @order_state.save
        format.html { redirect_to order_state_url(@order_state), notice: "Order state was successfully created." }
  ...
  def update
    respond_to do |format|
      if @order_state.update(order_state_params)
        format.html { redirect_to order_state_url(@order_state), notice: "Order state was successfully updated." }
