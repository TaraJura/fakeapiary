...
class BillingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create billing" do
    assert_difference("Billing.count") do
      post billings_url, params: { billing: { cod: @billing.cod, code: @billing.code, name: @billing.name } }
    end
  ...
  test "should update billing" do
    patch billing_url(@billing), params: { billing: { cod: @billing.cod, code: @billing.code, name: @billing.name } }
